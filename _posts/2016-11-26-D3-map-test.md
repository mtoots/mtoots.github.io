...
image:
  feature: ../../figure/posts/2016-11-26/featured-image.png
  topPosition: -50px
bgContrast: dark
bgGradientOpacity: lighter
syntaxHighlighter: yes
---
I want to learn more D3, so I decided to replicate the plot [originally done in R ]({{ site.baseurl }}2016/collaboration-network-EU-fp7.html) in D3. 

<svg></svg>

<script src="https://cdnjs.cloudflare.com/ajax/libs/d3/4.4.0/d3.min.js" charset="utf-8"></script>
<script src="{{ site.baseurl }}assets/javascripts/2016-11-26/europe_geojson_medres.js"></script>
