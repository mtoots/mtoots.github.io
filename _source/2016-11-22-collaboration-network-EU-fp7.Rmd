...
subtitle: Data exploration and collaboration networks
---
<span class="image featured"><img src="{{ site.baseurl }}figure/source/2016-11-22-collaboration-network-EU-fp7/featured_image.png" alt=""></span>
...
```{r, echo = FALSE}
cities <- readRDS(file = "../dat/eu/cities.rds")
```
...
```{r, echo=FALSE}
collaboration_network <- readRDS("../dat/eu/org_network.RDS")
```
...
```{r}
write_csv(city_contributions %>% mutate(city_contribution = parse_character(city_contribution)), "~/Code/blog/portfolio/posts_data/2016-11-26/city_contributions.csv")

city_contributions %>% 
  filter(lat == 51.5073509)

city_contributions %>% filter(is.na(city_contribution))
